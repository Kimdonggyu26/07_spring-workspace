                    ...
                    <tr>
                    	...
                    	<c:choose>
                        	...
                        	<th colspan="2" width="650">
                          	  <textarea class="form-control" rows="2" style="resize:none; width:100%" readonly>로그인 후 이용가능한 서비스입니다.</textarea>
                        	</th>
                        	<th style="vertical-align: middle"><button class="btn btn-secondary" id="reply_submit" disabled>등록하기</button></th>
                        </c:when>
                        <c:otherwise>
                        	<th colspan="2" width="650">
            	...
            	function fn_replyList(){
            		$.ajax({
            			...
            			success: function(res){
            				...
            				$("#rcount").text(res.length);	// 댓글 수 출력
            				let tr = "";
