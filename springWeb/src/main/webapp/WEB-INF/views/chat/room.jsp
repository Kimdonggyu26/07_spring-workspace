...
<div class="container p-3">
    ...
    <section class="row m-3" style="min-height: 500px">
      ...
      <script>
      	...
      	const sock = new SockJS("${contextPath}/chat"); // 웹소켓 서버와 연결됨(즉, ChatEchoHandler)
      	sock.onmessage = onMessage; // 웹소켓에서 해당 클라이언트로 메세지 발송 시 자동으로 실행할 함수 지정
      	...
      	/* 퇴장시 실행될 함수 */
      	function onClose() {
      		location.href="${contextPath}"; // 이페이지를 빠져나가면 ChatEchoHandler
      	}
