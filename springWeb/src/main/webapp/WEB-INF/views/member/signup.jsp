        ...
        <section class="row m-3" style="min-height: 500px">
          ...
          <div class="container border p-5 m-4 rounded">
            ...
            <script>
            	...
            	// input요소들 유효성 검사때마다 회원가입 버튼을 활성화 또는 비활성화 처리해주는 함수
            	function validate(){
            	...
            	// input 요소에 작성된 값이 정규식(유효한 패턴)에 만족하는지 체크해주는 함수
